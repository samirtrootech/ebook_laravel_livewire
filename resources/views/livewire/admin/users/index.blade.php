            ...
            <tbody>
                @foreach ($users as $user)
                    <tr>
                        ...
                        <th>
                            <div class="tooltip" data-tip="Favorite Books">
                                <a class="btn btn-ghost btn-xs"
                                    href="{{ route('admin.users.fav.books', ['user' => $user->uuid]) }}" wire:navigate>
                                    <span class="material-symbols-outlined">favorite</span>
                                </a>
                            </div>
                            <div class="tooltip" data-tip="Edit User">
                                <a class="btn btn-ghost btn-xs"
                                    href="{{ route('admin.users.edit', ['user' => $user->uuid]) }}" wire:navigate>
